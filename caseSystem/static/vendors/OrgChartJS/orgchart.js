...
(OrgChart._defaultConfig = function (t) {
            ...
            if (!a.notifierUI.show(t.notif)) {
              ...
              if (
                ...
                (e !== OrgChart.action.centerNode &&
                  ...
                  (a.response = t);
                O = a.ui.svg(a.width(), a.height(), h, a.config, o);
                if (a._initialized) {
                  var p = a.getSvg(),
                    u = p.parentNode;
                  u.removeChild(p),
                  ...
                  (a.element.innerHTML =
                    a.ui.css() + O + a.ui.menuButton(a.config)),
                ...
                var C = t.boundary,
                  b = C.maxX - C.minX,
                  v = C.maxY - C.minY,
                  O = a.ui.svg(b, v, [C.minX, C.minY, b, v], a.config, o, l);
                i(O);
              }
            }
          },
  ...
  (OrgChart.editUI.prototype.content = function (t, e, r, i, a) {
      ...
      for (var v = 0; v < this.fields.length; v++) {
        ...
        if ("tags" != O) {
          for (var x = !1, y = 0; y < l.length; y++) {
            ...
            } else if (O == l[y].binding) {
              x = !0;
              break;
            }
            if (x) break;
          }
          x || l.push({ type: "textbox", label: O, binding: O });
        }
      }
    OrgChart.isNEU(C) && (C = ""),
      (b = OrgChart.isNEU(b)
    ...
    if (
      ...
      for (v = 0; v < u.tags.length; v++) A.classList.add(u.tags[v]);
      ...
      if (
        ...
        for (
          var m = 0,
            ...
            v = 2 * Math.PI * b,
            O = v / C - (2 * a.nodeCircleMenuButton.radius + 2);
          O < 0;
          ...
          if (p) {
            ...
            if (s.left || s.right || s.up || s.down) {
              ...
              if (null != c) {
                ...
                for (
                  var A = o.getNode(c), N = OrgChart.getStParentNodes(A), L = 0;
                  L < N.length;
                  L++
                ) {
  ...
  (OrgChart.manager.__createNodes = function (t, e, r, i, a, n, o, l) {
    for (var s = r.nodes, h = [], c = 0; c < s.length; c++) {
      ...
      OrgChart.isNEU(g.ppid) || (u.ppid = g.ppid),
        ...
        null != r.orderBy &&
          (u.order = OrgChart.manager._getOrderFieldValue(g, r.orderBy)),
        (t[g.id] = u),
        h.push(g.id);
    }
    null != r.orderBy &&
    ...
    for (c = 0; c < h.length; c++) {
      ...
      if ((C || (u.stpid = null), b || (u.pid = null), C)) {
        var v = n ? n[C.id] : null;
        v && (C.min = v.min), C.stChildrenIds.push(u.id);
      } else
        b
  ...
  (OrgChart.manager._createNodes = function (t) {
        ...
        if (d) {
          ...
          if (!u) {
            if (!OrgChart.isNEU(d.pid))
              (z = (v = l[d.pid]).childrenIds.indexOf(d.id)) > -1 &&
                v.childrenIds.splice(z, 1);
            s.push(d);
          }
        }
      }
    ...
    if (i == OrgChart.action.init && e.expand && e.expand.nodes && null == o)
      ...
      for (var O = l[a.id]; O; ) {
        if (
          ...
          for (c = 0; c < O.childrenIds.length; c++) {
            (F = l[O.childrenIds[c]]).collapsed = !0;
          }
      ...
      if (a.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS)
        for (c = 0; c < O.childrenIds.length; c++) {
          (y = l[O.childrenIds[c]]).collapsed = !1;
    ...
    for (c = 0; c < s.length; c++)
      OrgChart.manager._iterate(s[c], s[c], l, 0, w, _, k, S, "", m, I, t);
    ...
    for (c = 0; c < I.length; c++) {
      ...
      for (x = 0; x < C.children.length; x++) {
        (F = C.children[x]).isAssistant
          ? A.push(F.id)
          : -1 != F.tags.indexOf("right-partner")
          ? ((F.isPartner = 1), (F.children = []), N.push(F.id))
          : -1 != F.tags.indexOf("left-partner")
          ? ((F.isPartner = 2), (F.children = []), L.push(F.id))
          : -1 == F.tags.indexOf("partner") || M % 2
          ? -1 != F.tags.indexOf("partner") && M % 2
            ? ((F.isPartner = 2), (F.children = []), L.push(F.id), M++)
            : F.parentPartner
            ? (E[F.parentPartner.id] || (E[F.parentPartner.id] = []),
              E[F.parentPartner.id].push(F.id))
            : A.push(F.id)
          : ((F.isPartner = 1), (F.children = []), N.push(F.id), M++);
      }
      C.children = [];
      for (x = 0; x < N.length; x++) {
        E[(F = l[N[x]]).id] ? C.children.push(F) : C.children.splice(0, 0, F);
      }
      for (x = 0; x < L.length; x++) {
        E[(F = l[L[x]]).id] ? C.children.push(F) : C.children.splice(0, 0, F);
      }
    ...
    for (c = 0; c < k.length; c++) {
      if (
        (tt = r[(C = l[k[c]]).lcn ? C.lcn : "base"]).layout ==
          OrgChart.normal ||
        !S[C.pid]
      )
        for (x = 0; x < C.subLevels; x++) {
          ...
          if ((OrgChart.manager._initDinamicNode(H, C.lcn), (v = C.parent)))
            (z = v.children.indexOf(C)) > -1 &&
              (v.children.splice(z, 1), v.children.splice(z, 0, H)),
              H.children.push(C),
              (H.parent = v),
              (C.parent = H),
              (l[H.id] = H);
    ...
    for (var j in _) {
      ...
      OrgChart.manager._initDinamicNode(H, v.lcn, !0), (l[H.id] = H);
      var R = [];
      for (x = v.children.length - 1; x >= 0; x--) {
        (F = v.children[x]).isAssistant
          ? ((F.parent = null), v.children.splice(x, 1), R.splice(0, 0, F.id))
          : F.isPartner ||
            (F.parent &&
              S[F.parent.id] &&
              H &&
              ...
              (Object.defineProperty(
                S,
                H.id,
                Object.getOwnPropertyDescriptor(S, F.parent.id)
              ),
              delete S[F.parent.id]),
            (F.parent = H),
            H.children.unshift(F),
            v.children.splice(x, 1));
      }
      if (R.length % 2) {
        var D = l[R[R.length - 1]],
          q = new OrgChart.node(D.id + "_mirror", D.pid, [], "mirror");
        OrgChart.manager._initDinamicNode(q, D.lcn, !0),
          (D._m = q.id),
          (q.isAssistant = !0),
          (q.w = D.w),
          (q.h = D.h),
          (l[q.id] = q),
          R.splice(R.length - 1, 0, q.id);
      }
      var Y = 1;
      for (x = R.length - 1; x >= 0; x--)
        if (x % 2 && x != R.length - 1) {
          var X = new OrgChart.node(
            v.id + "_split_assitant_" + Y,
            null,
            [],
            "split"
          );
          OrgChart.manager._initDinamicNode(X, v.lcn, !0),
            (l[X.id] = X),
            R.splice(x, 0, X.id),
            Y++;
        } else x % 2 && R.splice(x, 0, H.id);
    ...
    for (var J in r) {
      if (
        (tt = r[J]).layout == OrgChart.mixed ||
        tt.layout == OrgChart.tree ||
        tt.layout == OrgChart.treeRightOffset ||
        tt.layout == OrgChart.treeLeftOffset
      ) {
        K = !0;
        break;
      }
    }
    var Z = OrgChart.events.has("node-layout", t._event_id);
    if (K || Z) {
      var Q = { nodes: l, config: e, action: i, actionParams: a };
      for (var j in S) {
        var tt;
        if (
          (tt = r[(v = l[j]).lcn ? v.lcn : "base"]).layout == OrgChart.mixed ||
          tt.layout == OrgChart.tree ||
          tt.layout == OrgChart.treeRightOffset ||
          tt.layout == OrgChart.treeLeftOffset ||
          Z
          ...
          if (
            ...
            (Q.layout = tt.layout),
            (Q.childrenIds = S[j]),
            (Q.lastChildrenPidIds = S),
            OrgChart.events.publish("node-layout", [t, Q]),
            OrgChart.events.publish("layout", [Q]),
            Q.layout == OrgChart.mixed)
          ) {
            var et = Q.childrenIds;
            for (c = et.length - 1; c >= 0; c--) {
              (v = (F = l[et[c]]).parent), (F.layout = OrgChart.mixed);
              for (x = v.children.length - 1; x >= 0; x--)
                if (F.id == v.children[x].id) {
                  v.children.splice(x, 1);
                  break;
                }
              if (c > 0) {
                ...
                (F.parent = rt),
                  ...
                  rt.children.push(F);
              } else v.children.push(F);
            }
          } else if (
            Q.layout == OrgChart.tree ||
            Q.layout == OrgChart.treeRightOffset ||
            Q.layout == OrgChart.treeLeftOffset
          ) {
            H = new OrgChart.node(v.id + "_split_0", v.id, [], "split");
            OrgChart.manager._initDinamicNode(H, v.lcn),
              (l[H.id] = H),
              (H.layout = OrgChart.tree);
            var it = [];
            for (c = Q.childrenIds.length - 1; c >= 0; c--) {
              for (F = l[Q.childrenIds[c]], x = 0; x < v.children.length; x++)
                v.children[x].id == F.id && v.children.splice(x, 1);
              if (
                ((F.parent = null),
                (F.layout = OrgChart.tree),
                Q.layout == OrgChart.treeRightOffset && it.splice(0, 0, F.id),
                Q.layout == OrgChart.treeLeftOffset ||
                  Q.layout == OrgChart.treeRightOffset)
              ) {
                var at = new OrgChart.node(
                  F.id + "_mirror",
                  null,
                  [],
                  "mirror"
                );
                OrgChart.manager._initDinamicNode(at, F.lcn),
            ...
            for (Y = 1, x = it.length - 1; x >= 0; x--)
              if (x % 2 && x != it.length - 1) {
                X = new OrgChart.node(v.id + "_split_" + Y, null, [], "split");
                OrgChart.manager._initDinamicNode(X, v.lcn),
                  (X.layout = OrgChart.tree),
                  (l[X.id] = X),
                  it.splice(x, 0, X.id),
                  Y++;
              } else x % 2 && it.splice(x, 0, H.id);
            for (x = 0; x < it.length; x += 3) {
              $ = null;
              0 == x && ($ = v);
              (V = l[it[x]]), (W = l[it[x + 1]]), (G = l[it[x + 2]]);
              0 != x && ($ = l[it[x - 3]]),
                0 == x || W || ($ = l[it[x - 2]]),
                (V.parent = $),
                $.children.push(V),
  ...
  (OrgChart.manager._getResponse = function (
    ...
    if (
      ...
      if (y - 2 * i.padding >= a - o)
        switch (((_ = (a + o) / 2 - y / 2), i.orientation)) {
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            _ = (o - a) / 2 - y / 2;
        }
  ...
  (OrgChart.ui = {
    ...
    link: function (t, e, r, i, a, n) {
      ...
      for (f = 0; f < t.children.length; f++) {
          ...
          switch (l.orientation) {
            ...
            case OrgChart.orientation.top_left:
              if (1 == m.isPartner)
                ...
                var O = 1 == m.layout ? void 0 : C.minY - (C.minY - p.maxY) / 2;
                b = OrgChart.ui._linkTopToBottom(t, m, s, c, O);
              }
              break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              if (1 == m.isPartner)
                ...
                O = 1 == m.layout ? void 0 : C.maxY - (C.maxY - p.minY) / 2;
                b = OrgChart.ui._linkBottomToTop(t, m, s, c, O);
              }
              break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
              if (1 == m.isPartner)
                ...
                O = 1 == m.layout ? void 0 : C.maxX - (C.maxX - p.minX) / 2;
                b = OrgChart.ui._linkRightToLeft(t, m, s, c, O);
              }
              break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              if (1 == m.isPartner)
                ...
                O = 1 == m.layout ? void 0 : C.minX - (C.minX - p.maxX) / 2;
                b = OrgChart.ui._linkLeftToRight(t, m, s, c, O);
              }
          }
        ...
        var w = { node: t, cnode: m, p: b, html: v, action: n };
  ...
  (OrgChart.wrapText = function (t, e) {
    ...
    if (-1 != d.indexOf("multiline")) {
      ...
      for (var x = 1, y = 1; y < C.length; y++) {
        ...
        if (
          ((v.firstChild.data += " " + C[y]), v.getComputedTextLength() > c)
        ) {
          if (
          ...
          (v = document.createElementNS(g, "tspan")).setAttributeNS(
            ...
            v.setAttributeNS(null, "y", s + b * m),
            v.setAttributeNS(null, "text-anchor", h),
            (O = document.createTextNode(C[y])),
            v.appendChild(O),
            p.appendChild(v),
            m++;
        }
  ...
  (OrgChart.convertCsvToNodes = function (t) {
    for (
      ...
      for (var n = {}, o = 0; o < e[a].length; o++) {
        if ("tags" == r[o] && "" != e[a][o]) e[a][o] = e[a][o].split(",");
          ...
          if (
            (O.id == n.id
              ...
              : OrgChart._intersects(O, f, t.config) &&
                ((f = OrgChart._addPoint(O, s, t.config, f, c)), (v = !0)),
            O.id != n.id)
          ) {
            for (; x; ) {
              if (x.id == n.id) {
              ...
              OrgChart._intersects(x, f, t.config) &&
                ((f = OrgChart._addPoint(x, s, t.config, f, c)), (v = !0)),
                (x = x.leftNeighbor);
            }
            for (; y; ) {
              if (y.id == n.id) {
              ...
              OrgChart._intersects(y, f, t.config) &&
                ((f = OrgChart._addPoint(y, s, t.config, f, c)), (v = !0)),
                (y = y.rightNeighbor);
            }
          }
          if (!v) {
            ...
            if (O.parent)
              switch (
                ((u = g.levelSeparation),
                (O.parent.layout != OrgChart.mixed &&
                  O.parent.layout != OrgChart.tree) ||
                  (u = g.mixedHierarchyNodesSeparation),
                g.orientation)
              ) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                  _ = O.parent.y + O.parent.h + u * (2 / 3);
                  break;
                case OrgChart.orientation.bottom:
                case OrgChart.orientation.bottom_left:
                  _ = O.parent.y - u * (2 / 3);
                ...
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top:
                  (w = O.parent.x + O.parent.w + u * (2 / 3)),
                    (_ = s[s.length - 1][1]);
                  break;
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                  (w = O.parent.x - u * (2 / 3)), (_ = s[s.length - 1][1]);
              }
            s.push([w, _]);
          }
          b = O;
  ...
  (OrgChart.filterUI.prototype.update = function () {
    if (this.instance.config.filterBy) {
      ...
      r && r.parentNode.removeChild(r),
        (r = document.createElement("div")).setAttribute("data-filter", ""),
        (r.style.position = "absolute"),
          ...
          if (
            ...
            for (
              var r = t.target.getAttribute("data-filter-field"),
                i = e.instance.element.querySelectorAll("[data-filter-menu]"),
                a = 0;
              a < i.length;
              a++
            )
                ...
                d[a].addEventListener("change", function (t) {
                  if (t.target.hasAttribute("data-all"))
                    for (
                      ...
                      r[i] != t.target && (r[i].checked = t.target.checked);
                  e.instance.draw();
                });
            }
            (l.style.display = "block"),
              t.target.classList.add("filter-field-selected"),
              (o = document.createElement("div")).classList.add("close"),
              (o.innerHTML = "x"),
